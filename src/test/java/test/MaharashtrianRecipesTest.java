...
public class MaharashtrianRecipesTest {
...
@Test
   ...
   public void recipeScrappingMaharashtrian() throws Exception {
	...
	recipePageObj.textbox(ScrappingConfig.MaharashtrianText);
	recipePageObj.search();
	recipePageObj.linkclick();
	commonScrapPageObj.scrapAndWriteExcel(ScrappingConfig.excelPath,ScrappingConfig.MaharashtriansheetName);
